...
public class MyEventExplicitMapperTest {

    private MyEventExplicitMapper myEventExplicitMapper = Mappers.getMapper(MyEventExplicitMapper.class);

    @Test
    public void testEventId() {
        MyEvent myEvent = createEvent();

        MyEventDto result = myEventExplicitMapper.map(myEvent);
